...
func registerModulePath() {
    updateFileContent(
        filePath: currentPath + "Tuist/ProjectDescriptionHelpers/ModulePath.swift",
        finding: "enum \(layer.rawValue): String, CaseIterable {\n",
        inserting: "        case \(lowercasedModuleName)\n"
    )
    print("✅ Register \(layer.rawValue)Layer's \(moduleName)Module to ModulePath.swift")
}
...
let project = Project.makeModule(
    name: ModulePath.\(layer.rawValue).name + ModulePath.\(layer.rawValue).\(lowercasedModuleName).rawValue,
